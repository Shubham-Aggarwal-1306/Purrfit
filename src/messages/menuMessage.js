...
const menuMessage = new EmbedBuilder()
  .setThumbnail(
    "https://res.cloudinary.com/dn2jk5smj/image/upload/v1694522904/purrfit/menuIcon_znqeyf.png",
  )
  .addFields(
    {
      name: "Meow! Getting Started with Purrfit",
      value:
        "Hey there! I'm Purrfit, the purr-fect pal for gamers who care about their health. I'll nudge you kindly, keep track of your activities, and help you juggle fun and fitness. Pawsome, right?",
    },
    {
      name: "How to Begin",
      value: `
