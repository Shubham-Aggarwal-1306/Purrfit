...
const preferencesEmbed = new EmbedBuilder()
  .setThumbnail(
    "https://res.cloudinary.com/dn2jk5smj/image/upload/v1694522904/purrfit/preferecesIcon_rnw95u.png",
  )
  .setFields(
    {
...
const goalActionRow = new ActionRowBuilder().addComponents(goalSelectMenu);

const frequencyActionRow = new ActionRowBuilder().addComponents(
  frequencySelectMenu,
);
